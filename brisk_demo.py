...
extractor = cv2.BRISK_create()#('BRISK')  # non-patented. Thank you!
...
# Object Features
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
obj_original = cv2.imread('tiles/tile4.jpg', cv2.IMREAD_COLOR)
...
# Scene Features
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
scene_original = cv2.imread('tiles/board1-5.jpg',
                            cv2.IMREAD_COLOR)
...
scene_mask = cv2.imread('mask.jpg',
                        cv2.IMREAD_GRAYSCALE)
